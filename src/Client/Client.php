...
namespace Epartment\NShift\ShipmentServer\Client;

use Assert\Assert;
use Buzz\Client\Curl;
use Epartment\NShift\ShipmentServer\Request\RequestInterface;
use Epartment\NShift\ShipmentServer\Response\ResponseInterface;
...
class Client
{
     ...
     * @var string
     */
    protected $testServerUrl = 'http://demo.shipmentserver.com/ship/ShipmentServerModule.dll';
